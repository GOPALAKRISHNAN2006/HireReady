    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-600 to-primary-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-20 right-10 w-96 h-96 bg-primary-500/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: '1s' }}
          />
          <div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-primary-400/10 rounded-full blur-2xl animate-pulse"
        ...
        <div className="relative space-y-8">
          ...
          <p className="text-primary-100 text-xl leading-relaxed">
            Practice with intelligent questions, get instant feedback, and track your progress to
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <div className="group bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="text-primary-100">Practice Modes</div>
            </div>
            <div className="group bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="text-primary-100">Powered Feedback</div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-slate-50 to-white dark:from-[#0b1120] dark:to-[#0f172a] relative transition-colors duration-300">
