    ...
    return (
      ...
      >
        {({ isActive }) => (
          <>
            <item.icon
              className={`w-5 h-5 flex-shrink-0 ${isActive ? 'text-white' : 'text-slate-400 group-hover:text-primary-600'}`}
            />
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/60 dark:border-slate-800/60">
        <div className="flex items-center justify-between h-16 px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 bg-gradient-to-br from-primary-600 via-primary-600 to-primary-600 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/20">
          ...
          <div className="hidden md:flex flex-1 max-w-lg mx-8">
            ...
            >
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-2.5 bg-slate-100 dark:bg-slate-800 border-0 rounded-xl text-sm focus:ring-2 focus:ring-primary-500/50 focus:bg-white dark:focus:bg-slate-700 focus:shadow-lg focus:shadow-primary-500/10 placeholder:text-slate-400 transition-all"
              />
              <kbd className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] font-medium text-slate-400 bg-slate-200 dark:bg-slate-700 px-1.5 py-0.5 rounded hidden lg:inline">
                ⌘K
              </kbd>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <NavLink
              to="/"
              className="hidden sm:flex items-center gap-1.5 px-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary-600 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors"
            >
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 z-20 overflow-hidden">
                    ...
                    <div className="p-1.5">
                      <NavLink
                        to="/profile"
                        className="flex items-center gap-2.5 px-3 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl"
                    ...
                    <div className="p-1.5 border-t border-slate-100 dark:border-slate-800">
                      <button
                        ...
                        className="flex items-center gap-2.5 w-full px-3 py-2.5 text-sm text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-xl"
                      >
      ...
      >
        ...
        <div className="lg:hidden flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 bg-gradient-to-br from-primary-600 to-primary-600 rounded-lg flex items-center justify-center">
              <Shield className="w-4 h-4 text-white" />
            </div>
