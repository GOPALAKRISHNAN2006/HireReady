...
const CommunicationAssessmentCard = ({ 
  ...
  return (
    ...
    >
      {/* Header */}
      <div 
        className={`p-5 ${expandable ? 'cursor-pointer hover:bg-gray-50' : ''}`}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h3 className="font-semibold text-gray-900">Communication Assessment</h3>
              </div>
              {showQuestion && questionText && (
                <p className="text-sm text-gray-500 line-clamp-1">{questionText}</p>
              )}
            </div>
          </div>
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="font-medium text-gray-700">Detailed Breakdown</h4>
                  </div>
