...
const PremiumGate = ({ feature, fallback, blur = false, children }) => {
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-white/60 dark:bg-slate-900/70 backdrop-blur-[2px] rounded-xl">
          <div className="text-center p-6">
            <div className="w-14 h-14 mx-auto mb-3 bg-gradient-to-br from-primary-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg shadow-primary-500/30">
            ...
            <Link to="/premium">
              <Button className="bg-gradient-to-r from-primary-600 to-pink-600 hover:from-primary-700 hover:to-pink-700 text-white shadow-lg shadow-primary-500/25">
  ...
  return (
    <div className="border-2 border-dashed border-primary-200 dark:border-primary-800 rounded-2xl p-8 text-center bg-primary-50/50 dark:bg-primary-900/10">
      <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-primary-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg shadow-primary-500/30 animate-pulse-slow">
        <Crown className="w-8 h-8 text-white" />
      </div>
      <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Premium Feature</h3>
      <p className="text-slate-500 dark:text-slate-400 mb-6 max-w-sm mx-auto">
        This feature is available on paid plans. Upgrade to unlock AI feedback, advanced analytics,
        and more.
      </p>
      <Link to="/premium">
        <Button className="bg-gradient-to-r from-primary-600 to-pink-600 hover:from-primary-700 hover:to-pink-700 text-white shadow-lg shadow-primary-500/25">
