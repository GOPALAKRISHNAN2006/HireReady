...
const Spinner = ({ size = 'md', variant = 'default', className = '' }) => {
  ...
  const variants = {
    ...
    white: 'text-white',
    gradient: 'text-transparent bg-gradient-to-r from-primary-500 to-primary-500 bg-clip-text',
    neon: 'text-neon-green drop-shadow-lg',
  };

  return <Loader2 className={`animate-spin ${variants[variant]} ${sizes[size]} ${className}`} />;
};
      ...
      <div className="text-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary-500 to-primary-500 animate-pulse" />
          </div>
        </div>
