      ...
      <div className={`space-y-1.5 ${containerClassName}`}>
        ...
        <div className="relative group">
          ...
          {floating && (
            ...
            ${
              isFocused || value
                ? '-top-2.5 text-xs bg-white dark:bg-slate-800 px-1 text-primary-500'
          ...
          {variant === 'default' && (
            ...
            bg-gradient-to-r from-primary-500 via-primary-500 to-primary-500
        ...
        <div className="flex items-center justify-between">
          ...
          `}
            >
              {error ||
                (success && typeof success === 'string' ? success : helperText) ||
                helperText}
            </p>
          )}
...
export const Textarea = forwardRef(
  (
    ...
    const variants = {
      default:
        'border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 focus:border-primary-500 focus:ring-primary-500/20',
      filled:
        'border-transparent bg-slate-100 dark:bg-slate-700 focus:bg-white dark:focus:bg-slate-800 focus:border-primary-500',
      glass:
        'border-white/20 bg-white/10 backdrop-blur-md text-white placeholder:text-white/50 focus:border-white/40',
    };
    ...
    return (
      <div className={`space-y-1.5 ${containerClassName}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          {showCount && maxLength && (
            <span
              className={`text-xs ml-auto ${value.length >= maxLength ? 'text-red-500' : 'text-slate-400'}`}
            >
              {value.length}/{maxLength}
            </span>
          )}
