...
const Button = forwardRef(
  (
    ...
    const variants = {
      primary: `bg-gradient-to-r from-primary-600 via-primary-500 to-primary-500 text-white 
              hover:from-primary-700 hover:via-primary-600 hover:to-primary-600 
      ...
      outline: `border-2 border-primary-500 text-primary-600 bg-transparent
              hover:bg-gradient-to-r hover:from-primary-600 hover:to-primary-600 hover:text-white hover:border-transparent 
