...
const Settings = () => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      {/* Hero Banner Header */}
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-800 via-slate-900 to-primary-900 rounded-3xl p-8 text-white">
        {/* Decorative blur circles */}
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-white/10 rounded-full blur-2xl" />
        <div className="absolute bottom-0 left-1/4 w-32 h-32 bg-primary-500/10 rounded-full blur-2xl" />
        ...
        <div className="relative z-10 flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight flex items-center">
              <SettingsIcon className="w-8 h-8 mr-3 text-primary-400" />
              Settings
            </h1>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              ...
              <select
                ...
                className="px-4 py-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-primary-500 cursor-pointer"
              >
            ...
            <div className="flex items-center justify-between p-3 rounded-xl border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${
                  settings.reducedMotion ? 'bg-primary-600' : 'bg-slate-200'
                }`}
              >
                <div
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                desc: 'Get reminded about scheduled practices',
              },
              {
                key: 'weeklyReport',
                icon: MessageSquare,
                label: 'Weekly Progress Report',
                desc: 'Receive weekly summary of your progress',
              },
              {
                key: 'marketingEmails',
                icon: Mail,
                label: 'Marketing Emails',
                desc: 'Tips, offers, and updates',
              },
            ].map(item => (
              <div
                key={item.key}
              ...
              >
                ...
                <button
                  ...
                  className={`relative w-12 h-6 rounded-full transition-colors ${
                    settings[item.key] ? 'bg-primary-600' : 'bg-slate-200 dark:bg-slate-700'
                  }`}
                >
                  <div
                    className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow-md transition-transform ${
            ...
            {[
              {
                ...
                desc: 'Automatically save your responses',
              },
              {
                key: 'showHints',
                icon: Eye,
                label: 'Show Hints',
                desc: 'Display helpful hints during interviews',
              },
              {
                key: 'soundEnabled',
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-primary-500 cursor-pointer"
              >
