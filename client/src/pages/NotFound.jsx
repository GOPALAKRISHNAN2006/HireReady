    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div className="relative mb-8">
          ...
          >
            <span className="bg-gradient-to-br from-primary-500 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-sm">
              4
            </span>
            <span className="relative inline-block">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-28 h-28 md:w-36 md:h-36 border-4 border-dashed border-primary-300/40 dark:border-primary-500/30 rounded-full animate-spin" style={{ animationDuration: '8s' }} />
              </div>
            </span>
            <span className="bg-gradient-to-br from-primary-500 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-sm">
              4
        ...
        <p className="text-sm text-gray-400 dark:text-gray-500 mb-8">
          Auto-redirecting to home in <span className="font-bold text-primary-600 dark:text-primary-400">{countdown}s</span>
        </p>
        ...
        <form onSubmit={handleSearch} className="max-w-md mx-auto mb-10">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all shadow-lg shadow-gray-200/50 dark:shadow-gray-900/50"
            />
          </div>
        </form>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link to="/">
            <Button icon={Home} size="lg" className="shadow-lg shadow-primary-500/30 hover:shadow-xl hover:shadow-primary-500/40 transition-shadow">
              Go to Home
            </Button>
          </Link>
          <Button
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {popularPages.map((page) => (
              <Link
                key={page.path}
                to={page.path}
                className="group flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-primary-300 dark:hover:border-primary-600 hover:shadow-lg transition-all duration-200"
              >
