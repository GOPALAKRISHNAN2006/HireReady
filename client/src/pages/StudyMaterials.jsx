...
const StudyMaterials = () => {
  ...
  const categories = [
    ...
    { id: 'dsa', label: 'DSA', icon: Code, color: 'from-blue-500 to-primary-600' },
    {
      id: 'system-design',
      label: 'System Design',
      icon: Layers,
  ...
  const materials = [
    {
      ...
      description:
        'Master arrays, linked lists, trees, graphs, and more with detailed explanations, visual diagrams, and real interview examples.',
      category: 'dsa',
      type: 'article',
    ...
    },
    {
      ...
      description:
        'Learn the most common DP patterns used in coding interviews with step-by-step visual solutions and complexity analysis.',
      category: 'dsa',
      type: 'article',
      ...
      saved: false,
      progress: 0,
      tags: ['Memoization', 'Tabulation', 'Patterns'],
      author: 'HireReady',
    },
    {
      id: 3,
      ...
      saved: false,
      progress: 0,
      tags: ['Complexity', 'Quick Reference'],
      author: 'HireReady',
    },
    {
      id: 4,
      ...
      description:
        'Complete roadmap for system design interviews including distributed systems, load balancing, caching, and database sharding.',
    ...
    },
    {
      ...
      description:
        'Step-by-step guide to designing a URL shortening service. Covers API design, database schema, and caching.',
      category: 'system-design',
      type: 'article',
      ...
      saved: false,
      progress: 0,
      tags: ['API Design', 'Hashing', 'Caching'],
      author: 'HireReady',
    },
    {
      id: 6,
      ...
      description:
        'Understanding consistency, availability, and partition tolerance in distributed systems with real-world examples.',
      category: 'system-design',
      type: 'article',
    ...
    },
    {
      ...
      description:
        'Learn to structure your behavioral interview answers effectively using the STAR framework with example responses.',
      category: 'behavioral',
      type: 'article',
    ...
    },
    {
      ...
      description:
        'Most frequently asked behavioral questions at top tech companies with sample answers and evaluation criteria.',
      category: 'behavioral',
      type: 'cheatsheet',
      ...
      saved: false,
      progress: 0,
      tags: ['Common Questions', 'Interview Prep'],
      author: 'HireReady',
    },
    {
      id: 9,
      ...
      description:
        'Techniques to write efficient SQL queries — query execution plans, indexing strategies, and join optimization.',
      category: 'database',
      type: 'course',
      duration: '4 hours',
      difficulty: 'intermediate',
    ...
    },
    {
      ...
      description:
        'Comprehensive comparison of relational and non-relational databases with decision frameworks and use cases.',
      category: 'database',
      type: 'article',
      duration: '25 min read',
      difficulty: 'intermediate',
    ...
    },
    {
      ...
      description:
        'Learn containerization and orchestration from scratch. Covers Docker basics, K8s pods, services, and deployments.',
      category: 'devops',
      type: 'course',
      duration: '6 hours',
      difficulty: 'intermediate',
    ...
    },
    {
      ...
      description:
        'Key ML concepts and algorithms for interviews. Covers supervised, unsupervised, and deep learning fundamentals.',
      category: 'ml',
      type: 'article',
      ...
      saved: false,
      progress: 0,
      tags: ['Neural Networks', 'Classification', 'NLP'],
      author: 'HireReady',
    },
  ];
  ...
  const getTypeColor = type => {
    const colors = {
      ...
      course: 'from-primary-500 to-primary-600',
    };
  ...
  const getTypeTextColor = type => {
    const colors = {
      article: 'text-blue-500 dark:text-blue-400',
      video: 'text-red-500 dark:text-red-400',
      cheatsheet: 'text-amber-500 dark:text-amber-400',
      course: 'text-primary-500 dark:text-primary-400',
    };
  ...
  const inProgressCount = materials.filter(m => {
    const p = getEffectiveProgress(m);
    return p > 0 && p < 100;
  }).length;
  const savedCount = new Set([...savedMaterials, ...materials.filter(m => m.saved).map(m => m.id)])
    .size;

  return (
    <div className="max-w-7xl mx-auto space-y-8">
      {/* Gradient Header */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-600 p-8 text-white">
        ...
        <div className="relative">
          ...
          <p className="text-white/70 max-w-lg">
            Access curated study resources to ace your interviews
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-12 pr-10 py-3.5 border border-slate-200 dark:border-slate-700 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 shadow-sm"
          />
          {searchQuery && (
            <button
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          },
          {
            ...
            sub: 'text-pink-600 dark:text-pink-400',
          },
        ].map(stat => (
          <Card key={stat.label} className={`${stat.bg} ${stat.border} border`}>
            <div className="flex items-center gap-3">
              <div
                className={`w-11 h-11 bg-gradient-to-br ${stat.gradient} rounded-xl flex items-center justify-center shadow-lg`}
              >
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
        {filteredMaterials.map(material => {
          ...
          return (
            <Card
              key={material.id}
              className="group relative overflow-hidden hover:shadow-xl dark:hover:shadow-slate-900/50 transition-all duration-300 hover:-translate-y-1"
            >
              {/* Top accent bar */}
              <div
                className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${getTypeColor(material.type)}`}
              />
              ...
              <div className="pt-1">
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 bg-gradient-to-br ${getTypeColor(material.type)} rounded-xl flex items-center justify-center shadow-md`}
                    >
                      <TypeIcon className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <span
                        className={`text-[11px] font-bold uppercase tracking-wider ${getTypeTextColor(material.type)}`}
                      >
                        {material.type}
                      </span>
                ...
                {/* Title & Description */}
                <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors leading-snug">
                  {material.title}
                </h3>
                ...
                {material.tags && (
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {material.tags.map(tag => (
                      <span
                        key={tag}
                        className="px-2 py-0.5 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 text-xs rounded-lg font-medium"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                {progress > 0 && (
                  <div className="mb-4">
                    <div className="flex justify-between text-xs mb-1.5">
                      ...
                      <span
                        className={`font-bold ${progress === 100 ? 'text-emerald-600 dark:text-emerald-400' : 'text-blue-600 dark:text-blue-400'}`}
                      >
                        {progress}%
                      </span>
                    </div>
                ...
                <div className="flex items-center gap-3 mb-4 flex-wrap">
                  <span
                    className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold ${diffConfig.color}`}
                  >
                ...
                <div className="flex gap-2 pt-4 border-t border-slate-100 dark:border-slate-700">
                  ...
                  <Button size="sm" className="flex-1" onClick={startPractice}>
