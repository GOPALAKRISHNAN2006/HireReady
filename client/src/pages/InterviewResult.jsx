...
const InterviewResult = () => {
  ...
  const { data: communicationData } = useQuery({
    ...
    queryFn: () => communicationApi.getInterviewAssessments(id),
    enabled: !!id,
  })
    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">There was an error loading the interview results.</p>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <Card.Content>
            <div className="space-y-4">
              {interview?.categoryScores?.map((cat, index) => (
                <div key={index}>
      ...
      {communicationData?.assessments?.length > 0 && (
        <Card>
          <Card.Header>
            <Card.Title className="flex items-center">
          ...
          <Card.Content className="space-y-4">
            ...
            {communicationData.averageScore && (
              <div className="p-4 bg-purple-50 rounded-xl mb-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-3xl font-bold text-purple-600">
                    {communicationData.averageScore.toFixed(1)}/10
                  </div>
                </div>
              </div>
            )}
      ...
      <Card>
        ...
        <Card.Content className="space-y-4 max-h-[600px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  ...
                  <div className="p-4 border-t bg-gray-50 space-y-4">
                    ...
                    {response?.feedback && (
                      <div>
                        ...
                        <div className="text-gray-700 bg-blue-50 p-3 rounded-lg border border-blue-200 space-y-2">
