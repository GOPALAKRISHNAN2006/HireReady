        ...
        <div className="max-w-4xl mx-auto space-y-6 py-8">
          ...
          <Card className="p-8 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              There was an error rendering the interview results. Your interview data is saved.
            </p>
...
const InterviewResult = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card className="p-8 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            There was an error loading the interview results.
          </p>
          <Link to="/interview/setup">
  ...
  const totalQuestions =
    interview?.totalQuestions || interview?.questions?.length || responses.length || 0;
  ...
  const correctAnswers = responses.filter(
    r => r?.evaluation?.overallScore >= 70 || r?.isCorrect
  ).length;
  const duration = interview?.totalDurationSeconds
    ? Math.round(interview.totalDurationSeconds / 60)
    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card className="p-8 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            This interview session could not be found or may have expired.
          </p>
          <Link to="/interview/setup">
            <Button>Start New Interview</Button>
          </Link>
  ...
  return (
    <ResultErrorBoundary>
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Link
          to="/dashboard"
          className="inline-flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors group"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={i}
              className={`relative overflow-hidden bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 p-5 shadow-sm hover:shadow-lg ${stat.shadow} transition-all duration-300`}
            >
              <div
                className={`w-10 h-10 bg-gradient-to-br ${stat.gradient} rounded-xl flex items-center justify-center mb-3 shadow-lg ${stat.shadow}`}
              >
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-gradient-to-br from-primary-500 to-primary-500 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/20">
                    ...
                    (Array.isArray(interview.categoryScores)
                      ...
                      <div key={index}>
                        <div className="flex justify-between text-sm mb-2">
                          ...
                          <span
                            className={`font-semibold ${cat.score >= 80 ? 'text-emerald-600 dark:text-emerald-400' : cat.score >= 60 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400'}`}
                          >
                            {cat.score}%
                          </span>
                        </div>
                ...
                {(() => {
                  const insightItems = Array.isArray(interview?.insights)
                    ...
                    : interview?.insights?.topStrengths || interview?.insights?.areasToImprove
                      ? [
                          ...(interview.insights.topStrengths || []),
                          ...(interview.insights.areasToImprove || []),
                        ]
                      : null;
                    ...
                    return insightItems.map((insight, index) => (
                      ...
                      >
                        ...
                        <span className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
                          {typeof insight === 'string' ? insight : insight?.toString?.() || ''}
                        </span>
                      </li>
                    ));
                  }
        ...
        {communicationData?.assessments?.length > 0 && CommunicationAssessmentCard && (
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-gradient-to-br from-primary-500 to-pink-500 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/20">
            ...
            <div className="p-6 space-y-4">
              ...
              {communicationData.summary?.averageScore && (
                <div className="p-5 bg-gradient-to-r from-primary-50 to-pink-50 dark:from-primary-900/20 dark:to-pink-900/20 rounded-2xl border border-primary-100 dark:border-primary-800/30 mb-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-3xl font-bold bg-gradient-to-r from-primary-600 to-pink-600 bg-clip-text text-transparent">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium text-sm text-slate-900 dark:text-white text-left leading-snug">
                        Q{index + 1}: {(question?.text || 'Question').substring(0, 80)}
                    ...
                    <div className="flex items-center gap-2 ml-3 flex-shrink-0">
                      ...
                      <div
                        className={`w-6 h-6 rounded-lg flex items-center justify-center transition-transform duration-200 ${isExpanded ? 'rotate-180' : ''} bg-slate-100 dark:bg-slate-800`}
                      >
