        ...
        <div className="prose dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              By accessing and using HireReady, you agree to be bound by these Terms of Service. If
          ...
          <section>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              HireReady is an AI-powered interview preparation platform that provides mock
              interviews, skill assessments, performance analytics, and learning resources to help
          ...
          <section>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Our platform uses AI to generate interview questions, feedback, and recommendations.
              While we strive for accuracy, AI-generated content is provided for educational
              purposes and should not be considered professional career advice. Users should use
              their own judgment when applying suggestions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              All content, features, and functionality of HireReady — including the design, text,
              graphics, and software — are owned by HireReady and are protected by intellectual
              property laws. Your interview responses and personal data remain your property.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              HireReady is provided "as is" without warranties of any kind. We are not liable for
              any damages arising from your use of the platform, including but not limited to
              interview outcomes or career decisions made based on our service.
            </p>
          </section>
