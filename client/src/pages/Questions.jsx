        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full md:w-48 px-4 py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white"
            >
              {categories.map((cat) => (
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full md:w-40 px-4 py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white"
            >
