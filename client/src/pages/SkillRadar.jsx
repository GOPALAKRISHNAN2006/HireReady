...
const SkillRadar = () => {
  ...
  return (
    <div className="space-y-8 animate-slide-up">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-r from-cyan-600 via-blue-600 to-primary-600 rounded-3xl p-8 text-white shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <select
                    ...
                    className="px-3 py-1.5 text-sm border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-slate-800 dark:text-white"
                  >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  AI-powered suggestions to boost your skills
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {(() => {
          ...
          const mostImproved = [...skills].sort((a, b) => b.change - a.change)[0] || {
            name: 'N/A',
            change: 0,
          };
          ...
          return [
            ...
            },
            {
              ...
              subtext: `${mostImproved.change > 0 ? '+' : ''}${mostImproved.change}%`,
              icon: TrendingUp,
