      ...
      <div className="relative bg-white dark:bg-[#111827] rounded-2xl shadow-2xl dark:shadow-black/50 max-w-4xl w-full max-h-[90vh] overflow-hidden animate-slide-up">
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-600 p-6 text-white">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <p className="text-primary-200 text-sm">{pathName}</p>
          ...
          <div className="space-y-4">
            {milestone.studyMaterials?.map((material, index) => (
              <a
                ...
                className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-700/50 rounded-xl transition-colors group border border-slate-100 dark:border-slate-700/30 hover:border-primary-200 dark:hover:border-primary-500/30"
              >
                <div
...
const CareerRoadmap = () => {
  ...
  const milestones = {
    fullstack: [
      {
        ...
        studyMaterials: [
          {
            ...
            description: 'Complete beginner to advanced HTML and CSS tutorial',
          ...
          },
          {
            ...
            description: 'Official Mozilla documentation for HTML fundamentals',
          ...
          },
          {
            ...
            description: 'From basics to advanced topics with exercises',
          ...
          },
          {
            ...
            description: 'Learn Git version control from scratch',
        ...
        exercises: [
          ...
          },
          {
            ...
            description: 'Build a functional calculator with vanilla JavaScript',
            difficulty: 'Medium',
          },
        ],
      },
      {
        ...
        studyMaterials: [
          {
            ...
            description: 'Complete React.js tutorial with projects',
          ...
          },
          {
            ...
            description: 'Learn React from the official docs with interactive examples',
          ...
          },
          {
            ...
            description: 'Modern Redux state management made simple',
        ...
        exercises: [
          ...
          },
          {
            ...
            description: 'Create a product listing with filters and cart functionality',
            difficulty: 'Medium',
          },
        ],
      },
      {
        ...
        studyMaterials: [
          ...
          },
          {
            ...
            description: 'Hands-on tutorial building a complete REST API',
        ...
        exercises: [
          {
            ...
            description: 'Create a CRUD API for a blog application',
            difficulty: 'Medium',
          },
          {
      ...
      },
      {
        ...
        studyMaterials: [
          ...
          },
          {
            ...
            description: 'Free courses from MongoDB official learning platform',
          ...
          },
          {
            ...
            description: 'Learn Redis caching and data structures',
        ...
        exercises: [
          {
            ...
            description: 'Create normalized tables for an e-commerce platform',
            difficulty: 'Medium',
          },
          {
            title: 'MongoDB CRUD Operations',
            description: 'Build a data layer with Mongoose ODM',
            difficulty: 'Medium',
          },
        ],
      },
        ...
        exercises: [
          {
            ...
            description: 'System design for a URL shortening service',
            difficulty: 'Hard',
          },
          {
            title: 'Design Chat Application',
            description: 'Architecture for a real-time messaging system',
            difficulty: 'Hard',
          },
        ],
      },
      {
        ...
        studyMaterials: [
          ...
          },
          {
            ...
            description: 'Common coding interview patterns and solutions',
        ...
        exercises: [
          {
            ...
            description: 'Practice array, string, and tree problems',
            difficulty: 'Medium',
          },
          {
            title: 'Mock Interview Practice',
            description: 'Complete 5 mock technical interviews',
            difficulty: 'Hard',
          },
        ],
      },
    ...
    frontend: [
        ...
        studyMaterials: [
          {
            ...
            description: 'Modern HTML and CSS from scratch',
            url: 'https://www.youtube.com/watch?v=mU6anWqZJcc',
            duration: '6h',
            source: 'freeCodeCamp',
          },
          ...
          },
          {
            type: 'article',
            title: 'ES6 Features',
            description: 'All ES6+ JavaScript features explained',
        ...
        exercises: [
          {
            ...
            description: 'Build a mobile-first responsive website',
            difficulty: 'Easy',
          },
          {
            title: 'CSS Animation Gallery',
            description: 'Create an animated image gallery',
            difficulty: 'Medium',
          },
        ],
      },
      {
        ...
        studyMaterials: [
          ...
          },
          {
            ...
            description: 'Modern Redux with toolkit',
        ...
        exercises: [
          {
            ...
            description: 'React app with API integration and hooks',
            difficulty: 'Medium',
          },
          {
            title: 'Shopping Cart with Redux',
            description: 'E-commerce cart with Redux state management',
            difficulty: 'Hard',
          },
        ],
      },
        ...
        exercises: [
          {
            ...
            description: 'Build a dashboard with smooth transitions',
            difficulty: 'Medium',
          },
        ],
      },
      {
        ...
        studyMaterials: [
          {
            ...
            description: 'Core Web Vitals metrics explained',
          ...
          },
          {
            ...
            description: 'Make your React apps faster',
        ...
        exercises: [
          {
            title: 'Lighthouse Audit Fix',
            description: 'Improve a website score to 90+',
            difficulty: 'Hard',
          },
        ],
      },
    ...
    backend: [
      {
        ...
        studyMaterials: [
          ...
          },
          {
            ...
            description: 'Python Flask and Django basics',
        ...
        exercises: [
          ...
          },
          {
            ...
            description: 'Build a file upload endpoint',
            difficulty: 'Medium',
          },
        ],
      },
    ...
    devops: [
      {
        ...
        studyMaterials: [
          ...
          {
            type: 'article',
            title: 'SSH Essential Guide',
            description: 'Secure shell connections explained',
        ...
        exercises: [
          {
            title: 'Automate Backup Script',
            description: 'Create a backup automation script',
            difficulty: 'Easy',
          },
          {
            title: 'Server Setup',
            description: 'Configure a Linux web server',
            difficulty: 'Medium',
          },
        ],
      },
    ...
    data: [
      {
        ...
        studyMaterials: [
          {
            ...
            description: 'Master SQL for analytics',
            url: 'https://www.youtube.com/watch?v=HXV3zeQKqGY',
            duration: '4h',
            source: 'freeCodeCamp',
          },
        ...
        exercises: [
          ...
          },
          {
            ...
            description: 'Clean and prepare messy data',
            difficulty: 'Easy',
          },
        ],
      },
      {
        ...
        studyMaterials: [
          ...
          },
          {
            ...
            description: 'Introduction to Hadoop components',
        ...
        exercises: [
          {
            title: 'Spark Data Pipeline',
            description: 'Build an ETL pipeline with Spark',
            difficulty: 'Hard',
          },
          {
  ...
  const getStatusStyle = status => {
    switch (status) {
      ...
      case 'current':
        return 'bg-gradient-to-r from-primary-50 to-primary-50 border-primary-200 shadow-lg shadow-primary-500/10 dark:from-primary-900/20 dark:to-primary-900/20 dark:border-primary-500/20 dark:shadow-primary-500/5';
      case 'locked':
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-teal-600 via-emerald-600 to-teal-600 p-5 md:p-8 text-white">
        ...
        <div className="relative">
          ...
          <p className="text-white/70 max-w-lg">
            Explore career paths and plan your professional journey
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3">
          {careerPaths.map(path => (
            ...
            >
              <path.icon
                className={`w-5 h-5 ${selectedPath === path.id ? 'text-white' : 'text-slate-400 dark:text-slate-500'}`}
              />
          ...
          {currentMilestones.map((milestone, index) => (
            <div key={milestone.id} className="relative">
              ...
              {index < currentMilestones.length - 1 && (
                <div
                  className={`absolute left-7 top-16 w-0.5 h-20 ${
                    milestone.status === 'completed'
              ...
              <Card
                className={`${getStatusStyle(milestone.status)} border transition-all duration-300`}
              >
                      ...
                      <div className="flex items-center gap-6 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-600 dark:text-slate-400">
                            {milestone.interviews} interviews
                          </span>
                        </div>
                        {milestone.score > 0 && (
                          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Complete {currentMilestones.length - completedCount} more milestones to reach your
                goal
              </p>
            </div>
          </div>
