          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 cursor-pointer transition-all"
              >
                {CATEGORIES.map(cat => (
                  <option key={cat.value} value={cat.value}>
                    {cat.label}
              ...
              {formData.options.map((opt, i) => (
                <div key={i} className="flex gap-3 items-center">
                  <input
                    ...
                    className="w-5 h-5 text-primary-600 border-slate-300 dark:border-slate-600"
                  />
                  <Input
                    value={opt.text}
