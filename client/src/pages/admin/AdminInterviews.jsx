...
const STATUS_STYLES = {
  ...
  'in-progress':
    'bg-amber-50 text-amber-700 border border-amber-100 dark:bg-amber-900/20 dark:text-amber-400 dark:border-amber-800/30',
  pending:
    'bg-blue-50 text-blue-700 border border-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-800/30',
  scheduled:
    'bg-blue-50 text-blue-700 border border-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-800/30',
  cancelled:
    'bg-rose-50 text-rose-700 border border-rose-100 dark:bg-rose-900/20 dark:text-rose-400 dark:border-rose-800/30',
};
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold">
                    {CATEGORIES[interviewDetail?.category] ||
                      interviewDetail?.category ||
                      'Interview'}{' '}
                    Interview
                  </h2>
                  <p className="text-white/80 mt-1">
                    {interviewDetail?.totalQuestions || responses.length || 0} Questions •{' '}
                    {interviewDetail?.difficulty || 'N/A'} difficulty
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              ...
              <div className="bg-white/20 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold">
                  ...
                  {interviewDetail?.totalQuestions || responses.length || 0}
                </div>
              ...
              <div className="bg-white/20 rounded-lg p-3 text-center">
                <Badge
                  className={
                    STATUS_STYLES[interviewDetail?.status] ||
              ...
              <div className="bg-white/20 rounded-lg p-3 text-center">
                <Badge
                  className={
                    DIFFICULTY_STYLES[interviewDetail?.difficulty] ||
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm">
                  Unable to fetch interview details. Using basic information.
                </p>
              </div>
            ) : (
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-slate-900 dark:text-white">
                          {formatDate(interviewDetail?.startedAt || interviewDetail?.createdAt)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-500 dark:text-slate-400">Completed:</span>
                        <span className="text-slate-900 dark:text-white">
                          {formatDate(interviewDetail?.completedAt)}
                        </span>
                      </div>
                    </div>
                  </div>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {response.question?.difficulty && (
                                  <Badge
                                    className={`${DIFFICULTY_STYLES[response.question.difficulty] || 'bg-slate-100 dark:bg-slate-800'} text-xs`}
                                  >
                                    {response.question.difficulty}
                                  </Badge>
                                )}
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">
          Review all user interviews and their performance
        </p>
      </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-3">
                        <Badge
                          className={`rounded-lg ${STATUS_STYLES[interview.status] || 'bg-slate-50 text-slate-600 border border-slate-200 dark:bg-slate-800 dark:text-slate-400 dark:border-slate-700'}`}
                        >
                        ...
                        <Badge
                          className={`rounded-lg ${DIFFICULTY_STYLES[interview.difficulty] || 'bg-slate-50 text-slate-600 border border-slate-200 dark:bg-slate-800 dark:text-slate-400 dark:border-slate-700'}`}
                        >
