    ...
    <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">
                {analytics?.totalAptitudeTests || 0}
              </p>
              <p className="text-primary-600 dark:text-primary-400 text-sm mt-2 font-medium">
                <TrendingUp className="w-4 h-4 inline mr-1" />
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm">
        <div className="p-6 border-b border-slate-200/60 dark:border-slate-700/60">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            All mock interviews taken by this user
          </p>
        </div>
        <div className="p-6">
          {interviews.length > 0 ? (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        {interview.overallScore > 0 ? (
                          <span
                            className={`font-bold ${interview.overallScore >= 70 ? 'text-emerald-600 dark:text-emerald-400' : interview.overallScore >= 50 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400'}`}
                          >
                  ...
                  {aptitudeTests.map(test => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        {test.percentage > 0 ? (
                          <span
                            className={`font-bold ${test.percentage >= 70 ? 'text-emerald-600 dark:text-emerald-400' : test.percentage >= 50 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400'}`}
                          >
                            {test.percentage}%
                          </span>
                        ) : (
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm">
        <div className="p-6 border-b border-slate-200/60 dark:border-slate-700/60">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            All GD sessions participated in
          </p>
        </div>
        <div className="p-6">
          {gdSessions.length > 0 ? (
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  {gdSessions.map(session => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold bg-slate-100 text-slate-700 border border-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700">
                          {session.mode}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                      ...
                      <td className="px-4 py-3">
                        {session.feedback?.overallScore > 0 ? (
                          <span
                            className={`font-bold ${session.feedback.overallScore >= 70 ? 'text-emerald-600 dark:text-emerald-400' : session.feedback.overallScore >= 50 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400'}`}
                          >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm">
        <div className="p-6 border-b border-slate-200/60 dark:border-slate-700/60">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            All resumes created by this user
          </p>
        </div>
        <div className="p-6">
          {resumes.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {resumes.map(resume => (
                <div
                  key={resume._id}
                  className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 transition-colors"
                >
