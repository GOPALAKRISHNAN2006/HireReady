    ...
    <div className="py-3.5">
      <div className="flex items-center justify-between">
        ...
        <input
          ...
          min={min}
          max={max}
          className="w-24 px-3 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-center focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all"
        />
      </div>
    </div>
  );
    ...
    <div className="py-3.5">
      <div className="flex items-center justify-between">
        ...
        <select
          ...
          className="px-3 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 cursor-pointer transition-all"
        >
          {options.map(opt => (
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left transition-all ${
                    activeTab === tab.id
                      ? 'bg-gradient-to-r from-primary-50 to-primary-50 dark:from-primary-900/20 dark:to-primary-900/20 text-primary-700 dark:text-primary-400 font-semibold shadow-sm'
                      : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800'
                  }`}
                >
                  <Icon
                    className={`w-5 h-5 ${activeTab === tab.id ? 'text-primary-600 dark:text-primary-400' : ''}`}
                  />
                  {tab.label}
                </button>
              );
            ...
            <div className="space-y-1 divide-y divide-slate-100 dark:divide-slate-800">
              ...
              <div className="py-3.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all"
                />
              </div>
          ...
          {activeTab === 'interviews' && (
            <div className="space-y-1 divide-y divide-slate-100 dark:divide-slate-800">
              <div className="pb-4">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  Configure mock interview behavior
                </p>
              </div>
