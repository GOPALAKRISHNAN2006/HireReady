...
import { CommunicationStats, CommunicationAssessmentCard } from '../components/communication';
...
const CommunicationAssessment = () => {
  ...
  return (
    <div className="space-y-8 animate-slide-up">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-r from-primary-600 via-primary-600 to-primary-600 rounded-3xl p-8 text-white shadow-2xl">
        ...
        <div className="relative">
          ...
          <div className="mt-6 flex flex-wrap gap-6">
            ...
            <div>
              ...
              <div className="text-sm text-primary-100">Assessments</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-300">
                {statsData?.trends?.overall > 0 ? '+' : ''}
                {statsData?.trends?.overall?.toFixed(1) || '0'}%
              </div>
              <div className="text-sm text-primary-100">Improvement</div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {skills.map(skill => (
            <Card key={skill.name} className="text-center hover:shadow-lg transition-shadow">
              <div
                className={`w-12 h-12 mx-auto mb-3 bg-gradient-to-br ${skill.color} rounded-xl flex items-center justify-center shadow-lg`}
              >
      ...
      <Card className="bg-gradient-to-r from-primary-50 to-primary-50 border-none">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-500 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card
          className="bg-gradient-to-br from-blue-50 to-primary-50 border-blue-100 group hover:shadow-lg transition-all cursor-pointer"
        ...
        <Card
          className="bg-gradient-to-br from-primary-50 to-pink-50 border-primary-100 group hover:shadow-lg transition-all cursor-pointer"
          onClick={() => navigate('/interview/setup')}
        >
          <div className="flex items-center gap-4">
