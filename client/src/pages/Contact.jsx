      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 p-8 shadow-sm hover:shadow-md transition-all duration-300">
            <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-500 rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-primary-500/20">
              <Mail className="w-6 h-6 text-white" />
            </div>
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Email Us</h3>
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              For general inquiries, feedback, or support — reach out and we'll get back to you as
              soon as possible.
            </p>
            <a
        ...
        <div className="mt-12 bg-gradient-to-r from-primary-50 to-primary-50 dark:from-primary-900/20 dark:to-primary-900/20 rounded-2xl border border-primary-100 dark:border-primary-800/30 p-8 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-lg mx-auto">
            ...
            for answers to frequently asked questions, or join our{' '}
            <Link
              to="/community"
              className="text-primary-600 dark:text-primary-400 font-semibold hover:underline"
            >
