...
const InterviewFeedback = () => {
  ...
  const generateFeedback = interview => {
    ...
    if (avgScore >= 5 && avgScore < 7)
      strengths.push('Good foundational understanding of core concepts');
    if (answered === totalQ)
      strengths.push('Attempted all questions — shows commitment and confidence');
    ...
    questions.forEach(q => {
      ...
      if (q.score <= 4 && q.score > 0)
        improvements.push(`Review topic: "${q.question?.substring(0, 50)}..."`);
    });

    if (avgScore < 5) improvements.push('Consider deeper study of fundamental concepts');
    if (answered < totalQ)
      improvements.push(`${totalQ - answered} question(s) were left unanswered`);
    if (interview.duration && interview.duration < 300)
      improvements.push(
        'Spent very little time — consider taking more time to think through answers'
      );
    ...
    if (avgScore >= 7)
      tips.push('Challenge yourself with harder difficulty levels to keep growing');
        ...
        avgScore >= 8
          ...
          : avgScore >= 6
            ...
            : avgScore >= 4
              ...
              : 'Needs Improvement',
      performanceColor:
        avgScore >= 8 ? 'emerald' : avgScore >= 6 ? 'blue' : avgScore >= 4 ? 'amber' : 'red',
    };
  };
  ...
  if (!feedback) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-4">
          Complete an interview first to receive feedback.
        </p>
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <Card className="p-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <div className={`text-3xl font-bold text-${feedback.performanceColor}-600`}>
          ...
          <div>
            <div className="text-3xl font-bold text-amber-600">
              {feedback.totalQuestions - feedback.answered}
            </div>
      ...
      {activeTab === 'tips' && (
        <Card className="p-6">
          <h3 className="font-semibold text-lg text-slate-900 dark:text-white mb-4 flex items-center gap-2">
            <Lightbulb className="w-5 h-5 text-primary-500" /> Personalized Tips
          </h3>
          <div className="space-y-3">
