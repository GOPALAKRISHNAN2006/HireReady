  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'dark-xl': '0 20px 25px rgba(0, 0, 0, 0.5), 0 8px 10px rgba(0, 0, 0, 0.3)',
        'dark-glow-primary': '0 0 20px rgba(99, 102, 241, 0.25), 0 0 60px rgba(99, 102, 241, 0.1)',
        'dark-glow-purple': '0 0 20px rgba(139, 92, 246, 0.25), 0 0 60px rgba(139, 92, 246, 0.1)',
